def ips_between(start, end):
    ...
    first_sum = ((first_sum_split[0] * (256 ** 3)) + (first_sum_split[1] * (256 ** 2)) + (first_sum_split[2] * 256)
                 + first_sum_split[3])
    second_sum = ((second_sum_split[0] * (256 ** 3)) + (second_sum_split[1] * (256 ** 2)) + (second_sum_split[2] * 256)
                  + second_sum_split[3])
